                        ...
                        <ListItem avatar noBorder>
                            ...
                            <Body style={{flex:5.2}}>
                                ...
                                {item.senders.map((sender, index) => {
                                    return (
                                        <View key={index} style={{marginBottom:10}}>
                                            <Image style={{width:40,height:40,resizeMode:'contain'}} source={sender.avatar} />
                                ...
                                <View style={{
                                    ...
                                    <Button block style={{height: 27, flex: .9, marginRight: 5}}>
                                        <Text style={{fontSize: 12}}>Take Action</Text>
                                    </Button>
                                    <Button block style={{height: 27, flex: .9, marginLeft: 5}} bordered>
